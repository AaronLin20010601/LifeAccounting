...
namespace LifeAccounting_Backend.Services.Implements.VerifyCode
{
    public class RegisterVerificationService : IRegisterVerificationService
    {
        ...
        public RegisterVerificationService(LifeAccountingDbContext context, IEmailService emailService, IVerificationCode verificationCodeService)
        {
            _context = context;
